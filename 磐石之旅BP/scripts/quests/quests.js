...
export const weekly_pool = [
    {
        ...
        award: { exp: 50, items: [ { itemId: "stonecraft:stone_coin", amount: 10, name: { translate: "stonecraft.item.stone_coin" } } ] },
        iconPath: "textures/ui/quest/entities/stone_guard",
        autoComplete: true,
        manualReward: true
    },
    {
        ...
        award: { exp: 50, items: [ { itemId: "stonecraft:stone_coin", amount: 8, name: { translate: "stonecraft.item.stone_coin" } } ] },
        iconPath: "textures/ui/quest/entities/stone_shooter",
        autoComplete: true,
        manualReward: true
    },
    {
        ...
        award: { exp: 500, items: [ { itemId: "stonecraft:stone_bread", amount: 16, name: { translate: "stonecraft.item.stone_bread" } } ] },
        iconPath: "textures/items/foods/stone_bread",
        autoComplete: true,
        manualReward: true
    },
    {
        ...
        award: { exp: 60, items: [ { itemId: "stonecraft:lv3stone", amount: 2, name: { translate: "tile.stonecraft:lv3stone.name" } } ] },
        iconPath: "textures/items/treasures/stone_coin",
        autoComplete: true,
        manualReward: true
    },
    {
        ...
        award: { exp: 100, items: [ { itemId: "stonecraft:stone_star", amount: 1, name: { translate: "stonecraft.item.stone_star" } } ] },
        iconPath: "textures/ui/quest/entities/ancient_stone_totem",
        autoComplete: true,
        manualReward: true
    },
